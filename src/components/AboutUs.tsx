      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold mb-5">
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                <div key={item.label} className="card-elevated px-4 py-3 flex items-center gap-3 rounded-xl">
          ...
          >
            <div className="lifestyle-image group">
              <img
                ...
                loading="lazy"
              />
              <div className="absolute bottom-4 left-4 z-10 bg-card/90 backdrop-blur-sm rounded-xl px-4 py-3 shadow-lg">
