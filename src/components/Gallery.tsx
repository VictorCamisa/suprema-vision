...
const Gallery = () => {
  ...
  return (
    <section id="galeria" className="py-12 sm:py-16 section-light-grid section-rich">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto space-y-5">
          ...
          <div className="text-center pt-2">
            <a
              href="https://wa.me/556133638060?text=Ol%C3%A1%2C%20vi%20as%20fotos%20do%20T30%20e%20gostaria%20de%20agendar%20um%20test%20drive.&utm_source=site&utm_medium=galeria&utm_content=cta_galeria"
              target="_blank"
